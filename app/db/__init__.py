...
# imported functions from sqalchemy
from sqlalchemy.ext.declarative import declarative_base # base class variable helps us map the models to real MySQL tables.
from sqlalchemy import create_engine                    # create variable 'engine': manages the overall connection to the database
from sqlalchemy.orm import sessionmaker                 # session variable generates temporary connections fro performing CRUD 
